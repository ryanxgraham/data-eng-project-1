...
def process_song_file(cur, filepath):
    """
    Process a song file and load data into song and artist tables.
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Process a log file and load data into time, user, and songplay tables.
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    Get all files and interavly process them.
    """
...
def main():
    """
    Connect to database and run data processing functions.
    """
